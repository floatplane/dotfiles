;;; derived-mode.el --- C# mode derived mode
...
;;    font-locking. It is based on the c:-mode example from cc-mode.
;;
...
;;; Bugs:
;;
;;    Font lock does not operate on the extends and implements section
;;      public class ClassA : ClassB // ClassB in this example
;;   Literal strings @"" do not fonify correctly.
;;   "super" is still font-locked from the Java extension.
...
(c-lang-defconst c-modifier-kwds
  csharp '("public" "private" "const" "abstract"
	   "protected" "ref" "out" "static" "virtual"
	   "override" "params" "namespace" "internal"))
